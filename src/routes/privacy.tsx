          ...
          <section className="space-y-6 text-sm leading-7 text-muted-foreground whitespace-pre-wrap">
            {settings.privacyPolicy ? (
              ...
              <div className="space-y-6">
                <p>
                  At <strong>{shopName}</strong>, we are committed to protecting your privacy. This policy describes how we collect, use, and handle your information when you purchase digital items from our store.
                </p>
                ...
                <h2 className="text-base font-semibold text-foreground pt-4">2. How We Use Information</h2>
                <p>
                ...
                <h2 className="text-base font-semibold text-foreground pt-4">3. Third-Party Services</h2>
                <p>
                  We share minimum necessary information with third-party service providers who assist us in operating our store:
                </p>
                <ul className="list-disc pl-5 space-y-2">
                  <li><strong>Stripe:</strong> Our third-party payment gateway processes all checkout transactions.</li>
                  <li><strong>Email Delivery:</strong> We use third-party email providers (such as Resend) to send you order verification and digital asset links.</li>
                </ul>

                <h2 className="text-base font-semibold text-foreground pt-4">4. Security</h2>
                <p>
                  We implement industry-standard security measures to safeguard your personal data. Product access links are cryptographically random, unique to each purchase, and valid only for delivery.
                </p>
